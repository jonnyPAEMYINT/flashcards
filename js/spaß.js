document.addEventListener('DOMContentLoaded', () => {
  ...
  const flashcardColors = [
                            '#d9ead3', // soft pastel green (calming, easy to focus)
                            '#fff2cc', // light pastel yellow (matches paper, gentle)
                            '#f4cccc', // soft pastel red/pink (not too harsh)
                            '#cfe2f3', // light pastel blue (cool, relaxing)
                            '#e6e6fa', // soft lavender (soothing)
                            '#f5f5dc', // beige (paper-tone, very subtle)
                          ];
